...
/**
 * Client Component: wishlist state lives in localStorage via Zustand
 * today, which doesn't exist at build or server-request time. See
 * /ARCHITECTURE.md Section 2. Split out from page.tsx so the route can
 * still export static `metadata` (Client Components can't). Reuses
 * ProductCard exactly as it appears everywhere else; no bespoke wishlist
 * card exists.
 */
