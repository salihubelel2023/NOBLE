...
/**
 * Full-width search overlay triggered from the navbar icon. Filters the
 * in-memory product list client-side for now — the exact same
 * `searchProducts` helper the Catalog build step will reuse once a real
 * search index sits behind it.
 */
