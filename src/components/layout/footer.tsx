        ...
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr_1fr_1.2fr] md:gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="max-w-xs text-sm text-white/60">
              NOBLE helps you become the version of yourself people remember.
            </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 pt-2 text-sm text-white/60">
              <a href={siteConfig.phoneHref} className="flex items-center gap-2 hover:text-noble-gold">
                <Phone className="h-4 w-4" /> {siteConfig.phone}
              </a>
              <a href={`mailto:${siteConfig.email}`} className="flex items-center gap-2 hover:text-noble-gold">
